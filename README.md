...
| [Установка](#установка) | [Использование](#использование) | [Источники](#источники-скиллов) | [Что находит](#что-находит) | [Формат отчёта](#формат-отчёта) | [Платформы](#поддерживаемые-платформы) | [Лицензия](#лицензия) |
